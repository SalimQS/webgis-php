...
-- membuang struktur untuk table webgis-php.m_kabupaten
DROP TABLE IF EXISTS `m_kabupaten`;
CREATE TABLE IF NOT EXISTS `m_kabupaten` (
  `id_kabupaten` int(11) NOT NULL AUTO_INCREMENT,
  `kd_kabupaten` varchar(10) DEFAULT NULL,
  `nm_kabupaten` varchar(30) DEFAULT NULL,
  `geojson_kabupaten` varchar(30) DEFAULT NULL,
  `warna_kabupaten` varchar(10) DEFAULT NULL,
